#importar módulos - python -m pip install streamlit joblib numpy scikit-learn
...
from sklearn.preprocessing import StandardScaler #necessário para desserializar o padronizador
...
#ajuste de thresholds para capturar faixa intermediária
...
#passo 6: rodar python -m streamlit run visualizador.py