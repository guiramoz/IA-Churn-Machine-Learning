...
from sklearn.linear_model import LogisticRegression #modelo que gera probabilidades bem calibradas
...
#criando modelo com Logistic Regression (melhor para probabilidades)
modelo_churn = LogisticRegression(random_state=42, max_iter=1000)
